      ...
      <div class="flex justify-center min-h-screen">
        ...
        <div class="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
          <div class="w-full">
            ...
            <p class="mt-6 text-sm text-center text-gray-400">You have an account? 
              <a href="/auth" class="text-blue-500 focus:outline-none focus:underline hover:underline"> Sign in</a>
            </p>
          </div>
        </div>
      </div>
