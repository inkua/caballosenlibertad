...
export const TitleSection = ({titleTextContent, spanTextContent, children}) => {
  return (
    <section className='px-mobile md:px-tablet lg:px-desktop grid grid-cols-4 md:grid-cols-12 w-full mx-auto items-start gap-4 py-6 md:py-12 lg:py-14 max-w-content'>
      <h1
