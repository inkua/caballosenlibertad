...
export const Header = () => {
    ...
    return (
        <header className={`flex w-full items-center justify-center bg-primary text-whitePrimary px-4 lg:px-10 z-50 fixed top-0 h-[70px] lg:h-[90px] shadow-lg shadow-[rgba(0,0,0,0.35)] transition-all duration-500`}>
            <MenuBar />
