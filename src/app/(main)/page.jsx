...
export default function Home() {
  return (
    <main className='pt-[70px] lg:pt-[90px]'>
      ...
      >
        <Link href={'/sobrenosotros'} className='button-primary font-semibold md:text-xl mt-4 lg:mt-8 md:w-[360px] md:h-[64px] col-start-1 md:col-start-2 '>
          CONOCENOS
        </Link>
      </TitleSection>
      <section className="w-full text-center text-lg my-20 lg:my40 border-2 border-gray-900 bg-gray-300 py-3 max-w-banner">Video presentación</section>
