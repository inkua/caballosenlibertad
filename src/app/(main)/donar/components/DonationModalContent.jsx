    ...
    <div>
        {
            ...
            <>
                ...
                <div className='w-full lg:mt-6 flex space-x-2 md:space-x-4 lg:space-x-8'>
                    <button className='button-primary w-full md:max-w-[248px] leading-4 h-[40px] lg:h-[50px] !px-2 lg:!px-0 flex items-center justify-center text-nowrap  text-[13px] lg:text-[16px] font-semibold'>ENVIAR CORREO</button>
                    <button className='button-primary w-full md:max-w-[248px] h-[40px] lg:h-[50px] !px-0 flex items-center justify-center text-[13px] lg:text-[16px] font-semibold'>CHATEAR</button>
                </div>
            </>
        }
        {
