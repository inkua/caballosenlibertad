    ...
    return (
        <div className='flex flex-col gap-6 justify-between lg:h-full mb-10 md:mb-0' aria-labelledby="adopciones-card-title">
            ...
            <p className='font-light text-[12px] md:text-sm lg:text-xl'>
                Si tenes conocimientos en redes sociales, veterinaria, posees experiencia en trabajo con caballos en el capo, tienes licencia de conducir, o posees cualquier otro conocimiento que aporte a alguna de las áreas mencionadas. Podes sumerte a colaborar.
            </p>
            <p className='font-light text-[12px] md:text-sm lg:text-xl'>
