export default function ContactMap({ ubication, phone }) {
    return (
        <div className='flex flex-col justify-between gap-4 w-full md:w-[50%]'>
            ...
            <h2 className='font-extrabold text-primary text-h2 duration-200 mt-8 md:mt-4 hidden md:block'>Teléfono</h2>
            <p className='text-primary text-p3 duration-200 hidden md:block'>{phone}</p>
        </div>
    )
}